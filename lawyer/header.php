            ...
            <ul class="sidebar-nav">
			    ...
			    <li class="nav-item">
				    <a class="nav-link" data-toggle="collapse" href="#appointmentsDropdown" aria-expanded="false" aria-controls="appointmentsDropdown">
				        <i class="fa fa-home"></i> Appointments <i class="fa fa-caret-down dropdown-icon"></i>
				    </a>
				    <div class="collapse" id="appointmentsDropdown">
				        <ul class="nav flex-column">
				            <li class="nav-item <?= isActive('all-appointments.php'); ?>">
				                <a class="nav-link" href="all-appointments.php">All Appointments</a>
				            </li>
				            <li class="nav-item <?= isActive('today-appointments.php'); ?>">
				                <a class="nav-link" href="today-appointments.php">Today's Appointments</a>
				            </li>
				        </ul>
				    </div>
				</li>
				<li class="nav-item <?= isActive('my-clients.php'); ?>">
				    <a class="nav-link" href="my-clients.php">
				        <i class="fa fa-users"></i> My Clients
				    </a>
				</li>
			</ul>
        </div>
