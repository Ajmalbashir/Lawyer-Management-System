...
<head>
	...
	<style>
		.custom_register_login > li {
			padding: 10px !important;
		}
		.custom_register_login > li:hover, .custom_register_login > li:focus {
			background-color: #D64C4C !important;
		}
		.custom_register_login > li > a:hover, .custom_register_login > li > a:focus {
			background-color: #D64C4C !important;
		}
	</style>
</head>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-8 nav-wrapper">
						...
						<!-- Nav Start -->
						<div class="nav">
							<ul class="sf-menu" style="margin-left: -45px;">
								...
								// Add the new option for "e-library"
								// echo '
								// <li>
								//     <a href="'.BASE_URL.'e-library.php">
								//         <span class="menu-title">
								//             e-library
								//         </span>
								//     </a>
								...
								<li class="dropdown">
								    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="menu-title">Account</span></a>
								    <ul class="dropdown-menu custom_register_login">
